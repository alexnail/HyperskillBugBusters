...
public class ExceptionsTests extends StageTest {
  ...
  @DynamicTest(data = "dataForTesting", order = 35)
  ...
  @DynamicTest(data = "dataForTesting", order = 36)
  ...
  @DynamicTest(data = "dataForTesting", order = 37)
  ...
  @DynamicTest(data = "dataForTesting", order = 38)
  CheckResult IllegalArgumentExceptionCheck(String typeEx, String type, Object[] data, Object additional) {
    ...
    pr.execute(typeEx);
    CheckFeedback(pr.execute("/getRandom"), "There are no elements memorized",
            "Random element with no elements memorized", type);
    return CheckResult.correct();
  }

  @DynamicTest(order = 39)
  ...
  @DynamicTest(data = "dataForTesting", order = 40)
  ...
  @DynamicTest(data = "dataForFeedbacks", order = 42)
  ...
  @DynamicTest(order = 45)
  CheckResult RegexFeedbackCheck() {
    TestedProgram pr = new TestedProgram();
    pr.start();
    pr.execute("3");//Words
    CheckFeedback(pr.execute("/regex .+"), "There are no strings that match provided regex",
